import map from "@/assets/UnitMap.png";
import {
  Button,
  Imageslider,
  Modal,
    ...
    <>
      ...
      >
        <div className="absolute bottom-0 left-0 md:flex justify-start items-center md:space-x-4 md:ml-5 ml-2">
          <Button
            className={"bg-blue-600 min-w-max text-xs md:text-sm px-2 py-2"}
            onClick={OpenGallery}
          >
            Gallery
          </Button>
          {false && (
            <Button
              className={
                "bg-blue-600 min-w-max md:ml-0 ml-1 text-xs md:text-sm px-2 py-2"
              }
              onClick={OpenMapView}
            >
              Map View
          ...
          {arial_videos && (
            <Button
              className={
                "bg-blue-600 min-w-max md:mt-0 mt-1 mb-1 ml-1 md:mb-0 text-xs md:text-sm px-2 py-2"
              }
