...
const validationSchema = Yup.object({
  ...
  // card_expiry_date: Yup.string().required("Required!"),
...
export const CardPaymentForm = () => {
  ...
  const onSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      console.log(token);
      dispatch(addPaymentMethod({ ...values, type: "Card", token: token.id }));
      resetForm();
      setLoading(false);
    } catch (error) {
  ...
  return (
    <div className="md:border md:border-blue-500 md:p-4">
      <div className="md:flex justify-between items-center">
        <h2 className="text-xl font-bold">New Credit/Debit Card</h2>
      </div>
