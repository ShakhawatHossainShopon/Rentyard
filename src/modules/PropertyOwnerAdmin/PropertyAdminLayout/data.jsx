...
export const menus = [
  ...
  },
  {
    ...
    path: "/propertyadmin/notice",
    icon: (
      <span>
        <Icons.Announce className="w-5 h-5" />
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    path: "/propertyadmin/singlehouseproperty",
    icon: (
      <span>
...

  {
    ...
    path: "/propertyadmin/provider",
    icon: (
      <span>
        <Icons.Provide className="w-5 h-5" />
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    path: "/propertyadmin/custom",
    icon: (
      <span>
        <Icons.Sheet className="w-5 h-5" />
      </span>
    ),
  },
  {
    label: "Monthly Statements",
    path: "/propertyadmin/statements",
    icon: (
      <span>
        <Icons.Statement className="w-5 h-5" />
      </span>
    ),
  },
  {
    label: "Deposits",
    path: "/propertyadmin/deposit",
    icon: (
      <span>
        <Icons.Deposit className="w-5 h-5" />
      </span>
    ),
  },
  {
    label: "Transactions",
    path: "/propertyadmin/transactions",
    icon: (
      <span>
