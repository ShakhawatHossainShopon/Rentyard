...
export const AddProperty = ({ setShowForm }) => {
  ...
  const onSubmit = (values, { resetForm }) => {
    dispatch(addProperty({ ...values, published: published }));
    resetForm();
    setShowForm(false);
    setCoverPhoto(null);
  ...
  return (
    <div className="w-full">
      <div className="w-full space-y-10">
        <p className="bg-pink-50 px-2 py-1">
        ...
        >
          {({ setFieldValue, touched, errors, values }) => {
            useEffect(() => {
              console.log(values.property_images);
            }, [values]);
            ...
            return (
              <Form className="space-y-5 pb-5">
                ...
                <div className="md:bg-gray-50 md:p-4 md:border md:border-blue-500">
                ...
                <div className="md:bg-gray-50 md:p-4 md:border md:border-blue-500">
                  <h3 className="font-medium">Pet Fees</h3>
                  <hr className="border-gray-300 mt-1 mb-3" />
                  <FieldArray name="pet_policy">
                    {({
                      push,
                      remove,
                      form: {
                              ...
                              >
                                <div className="md:flex justify-start items-center md:space-x-10 space-y-5 md:space-y-0 w-full relative">
                                  <Input
                                    required={true}
                                    label={"Title"}
                                    placeholder={"Pet Fee(Per Pet)"}
                                    name={`pet_policy[${index}].name`}
                                    className={"py-2 px-2"}
                                  />
                                  <Input
                                    required={true}
                                    label={"Amount"}
                                    placeholder={"50"}
                                    name={`pet_policy[${index}].amount`}
                                    className={"py-2 px-2"}
                                  />
                                  <Select
                                    name={`pet_policy[${index}].based_on_term`}
                                    required={true}
                                    label={"One-time/Monthly"}
                                    options={[
                                      {
                                  ...
                                  />
                                  <Select
                                    name={`pet_policy[${index}].refundable`}
                                    required={true}
                                    label={"Refund/Non-Refund"}
                                    options={[
                                      {
                                ...
                                <div className="flex justify-start items-center space-x-2">
                                  ...
                                  {index === values.pet_policy.length - 1 ? (
                                    <Button
                                      type="button"
                                      onClick={() =>
                                        push({
                ...
                <div className="md:bg-gray-50 md:p-4 md:border md:border-blue-500">
                  <h3 className="font-medium">Required Document To Apply</h3>
                  <hr className="border-gray-300 mt-1 mb-3" />
                              ...
                              >
                                <div className="md:flex justify-start items-center md:space-x-10 space-y-5 md:space-y-0 w-full relative">
                                  <Select
                                    ...
                                    options={[
                                      ...
                                      },
                                      {
                                        ...
                                        value: "Identity Proof Documents",
                                      },
                                      {
                                        label: "Monthly Income Requirement",
                                        value: "Monthly Income Requirement",
                                      },
                                    ]}
                                    className={"w-full border px-2 py-2"}
                                    parentClassName={"w-full px-0 py-0"}
                                  ...
                                  <Input
                                    required={true}
                                    label={
                                      "Required Document Name(One or Multiple)"
                                    }
                ...
                />
                <div className="md:flex justify-start items-center md:space-x-4 space-y-4 md:space-y-0">
                  <FileUpload
                    data={data}
                    loading={loading}
                ...
                <div className="md:flex justify-start items-end md:space-x-4 space-y-4 md:space-y-0">
                  <MultipleVideoUpload
                    name={"tour_videos"}
                    id={"tour_videos"}
                    label={"Upload Property Virtual Tour Videos"}
                    parentClassName={"w-fit"}
                    className={"w-fit pr-5"}
                    setFieldValue={setFieldValue}
                    data={data}
                  ...
                  {videos2.length > 0 && (
                    <div>
                      <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                        ...
                        {videos2.slice(0, 3).map((video, index) => (
                          <div key={index} className="w-60 border relative">
                            <video controls>
                              <source
                                src={`${config.url.ASSET_URL}${video.link}`}
                ...
                <div className="md:flex justify-start items-end">
                  <MultipleVideoUpload
                    name={"arial_videos"}
                    id={"arial_videos"}
                    label={"Upload Property Arial Video"}
                    parentClassName={"w-fit"}
                    className={"w-fit pr-5"}
                    setFieldValue={setFieldValue}
                    data={data}
                  ...
                  <div>
                    {videos3.length > 0 && (
                      <div className="md:mx-4">
                        <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 ">
                          {/* Render the first 3 videos */}
                          {videos3.slice(0, 3).map((video, index) => (
                            <div key={index} className="w-60 border relative">
                              <video controls>
                                <source
                                  src={`${config.url.ASSET_URL}${video.link}`}
