...
export const UpdateProperty = ({ item, closeModal }) => {
  const stateOptions = [
    {
      label: "Select State",
      value: "",
          ...
          {({ setFieldValue, touched, errors, values, setValues }) => {
            ...
            return (
              <Form className="space-y-5 pb-5">
                ...
                <div className="md:bg-gray-50 md:p-4 p-0 md:border md:border-blue-500">
                                ...
                                <div className="md:flex justify-start items-center md:space-x-10 w-full relative space-y-5 md:space-y-0">
                                  <Select
                                    ...
                                    options={[
                                      ...
                                      {
                                        label: "Monthly Income 2.5x plus",
                                        value: "Monthly Income 2.5x plus",
                                      },
                                    ]}
                                    className={"w-full border px-2 py-2"}
                                    parentClassName={"w-full px-0 py-0"}
                ...
                />
                <div className="md:flex mt-5 md:mt-0 justify-start items-center md:space-x-4">
                  <FileUpload
                    data={data}
                    loading={loading}
