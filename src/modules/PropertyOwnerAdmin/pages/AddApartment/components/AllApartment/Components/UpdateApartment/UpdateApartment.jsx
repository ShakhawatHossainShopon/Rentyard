...
export const UpdateApartment = ({ item, updatedProperties }) => {
  const dispatch = useAppDispatch();
  const onSubmit = (values) => {
    console.log(values);
    dispatch(updateApartment(values));
  };
          ...
          <Form className="w-full space-y-5">
            ...
            <div className="w-full md:flex justify-center items-center md:space-x-6 space-y-5 md:space-y-0">
              ...
              <Datepicker
                ...
                parentClassName={""}
                onChange={(e) => {
                  setFieldValue("available_date", e);
                }}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex justify-start items-center space-x-2">
                              ...
                              {index === values.discount.length - 1 ? (
                                <Button
                                  type="button"
                                  onClick={() =>
                                    push({
                        ...
                        return (
                          ...
                          >
                            <div className="w-full grid grid-cols-4 gap-6">
                              ...
                              <div className="col-span-2">
                                <Input
                                  label={"Utility Provider/Additional Notes"}
                                  placeholder={
                                    "Name and Account number need at Move in"
                                  }
              ...
              {previewUrls2.length > 0 && (
                <div>
                  <div className="md:flex justify-start items-center md:space-x-3 md:space-y-0 space-y-5">
                    {previewUrls2.slice(0, 3).map((url, index) => (
                      <div
                        key={index}
                        className="h-32 w-32 overflow-hidden border relative rounded-lg"
                      >
            ...
            <div className="md:flex justify-start items-center md:space-x-4 space-y-5 md:space-y-0">
              <FileUpload
                ...
                id={"unit_image"}
                placeholder={"Unit Map image if you have"}
                name={"unit_image"}
              ...
              />
              {mapPreview && (
                <div className="mt-5 md:mt-0 rounded-lg h-32 w-32 overflow-hidden border relative">
                  <LazyLoadImage
                    className="h-32 w-32 rounded-lg object-cover"
            ...
            <div className="md:flex justify-start items-center md:space-x-4 space-y-5 md:space-y-0">
              <SingleVideoUpload
                ...
                id={"tour_video"}
                placeholder={"Upload Virtual Tour Video"}
                name={"tour_video"}
              ...
              />
              {tourPreview && (
                <div className="mt-5 md:mt-0 w-60 border relative">
                  <video controls>
                    <source
