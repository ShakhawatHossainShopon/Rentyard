...
export const PhoneInput = ({
  ...
  return (
    <div className="w-full">
      ...
      <div
        className={`relative flex w-full border border-blue-500 ${
      ...
      >
        <Menu placement="bottom-start">
          <MenuHandler>
            <Button
              ...
              variant="text"
              color="blue-gray"
              className="flex h-10 items-center gap-2 rounded-none bg-blue-gray-500/10 pl-3"
            >
              <img
                src={flags.svg}
                alt={name}
          ...
          <MenuList className="max-h-[20rem] max-w-[18rem] z-[999999999999999999]">
            <div className="p-2">
              <input
                type="text"
        ...
        <input
          ...
          className="h-10 w-full border-none px-3 outline-none"
        />
      </div>
    </div>
  );
